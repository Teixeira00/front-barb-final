...
//             if (agendamentoData) {
//                 setAgendamento(JSON.parse(agendamentoData));
//                 setError(''); // Limpar mensagem de erro se encontrado
//             } else {
//                 setAgendamento(null);
//                 setError('Agendamento não encontrado. Verifique o CPF e tente novamente.');
//             }
//         }
//     }, [cpf]);
...
//     const handleConsultAnotherClick = () => {
//         router.push('/consult'); // Redireciona para a página inicial onde o CPF pode ser consultado novamente
//     };
...
//             localStorage.removeItem(`agendamento_${cpf}`);
//             setAgendamento(null);
//             setError('Agendamento excluído com sucesso.');
//         }
//     };
